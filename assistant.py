    ...
    def assist(self):
        ...
        for resp in self.assistant.Assist(iter_log_assist_requests(),
            ...
            if resp.speech_results:
                ...
                self.speech_result_text = ' '.join(r.transcript for r in resp.speech_results)
            ...
            if resp.dialog_state_out.conversation_state:
                ...
                self.answer_text = resp.dialog_state_out.supplemental_display_text
                logging.info('answer_text %s', self.answer_text)
            ...
            if resp.screen_out.data:
                self.answer_text_2 = resp.screen_out.data
                logging.info('answer_text_2 %s', self.answer_text_2)
...
detector = snowboydecoder.HotwordDetector('snowboy/Grechen.pmdl', sensitivity=0.5)
